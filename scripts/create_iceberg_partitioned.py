...
def create_spark_session():
    ...
    spark = SparkSession.builder.appName("CreateIcebergTable").getOrCreate()

    return spark


def load_parquet_and_create_iceberg_table(
    spark, parquet_path="/home/iceberg/partitioned", table_name="demo.spark.hits"
):
    ...
    df.writeTo(table_name).partitionedBy(f.months(f.col("eventdate"))).createOrReplace()
