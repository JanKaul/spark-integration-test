...
cb_create_table
# cb_copy_into_partitioned_n_file 0
# cb_copy_into_partitioned_n_file 1
...
snowsql "COPY INTO demo.embucket.source FROM 'file://$(pwd)/clickbench/partitioned/hits_1.parquet' STORAGE_INTEGRATION = local FILE_FORMAT = (TYPE = PARQUET);"
